  ...
  useEffect(() => {
    if (phase === 'questions' && studentInfo) {
      ...
      const timeoutId = setTimeout(async () => {
        ...
        // Build array of all audio files: question + all answer options
        const audioFiles = [
          question.audioPath,
          ...
          {phase === 'passage' && (
            <div className="text-center">
              {!hasStarted ? (
                ...
                <div className="flex flex-col items-center">
                  {/* Speaker Icon - non-clickable */}
                  <div
                    className={`w-24 h-24 rounded-xl flex items-center justify-center mb-6 transition-all ${
                      isPlaying
