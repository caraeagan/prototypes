...
export const PHASES: Phase[] = [
  ...
  { name: "Pre-Norming", startMonth: 4, duration: 2.887, color: "#FEF3E8" },
  { name: "Norming", startMonth: 6.887, duration: 6.113, color: "#E8FEF0" },
...
export const TEAMS: Team[] = [
  { name: "Engineering", color: "#2563EB", members: ["Oleksii", "John", "Liuda", "AK", "Hlib", "Lucie", "Alex", "Patrick", "Daryl"] },
